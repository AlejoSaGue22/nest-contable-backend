...
export class NominaController {
    ...
    liquidarPeriodo(@Param('id') id: string, @Body() dto: LiquidarNominaDto, @Req() req: AuthenticatedRequest) {
    ...
    pagarNomina(@Param('id') id: string, @Body() dto: PagarNominaDto, @Req() req: AuthenticatedRequest) {
    ...
    @Permissions(Permission.NOMINA_REPORT_READ)
    async comparativoPeriodos(
        @Query('periodo1Id') periodo1Id: string,
        @Query('periodo2Id') periodo2Id: string,
    ) {
